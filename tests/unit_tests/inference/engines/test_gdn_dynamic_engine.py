...
``SSMInferenceStateConfig.from_model``, slot management, mixed batches, CUDA
...
class _GDNDynamicEngineMixin:
    ...
    def _build_test_env(cls, test_config):
        ...
        assert ssm_inference_state_config is not None, "GDN hybrid should yield an SSM state config"
